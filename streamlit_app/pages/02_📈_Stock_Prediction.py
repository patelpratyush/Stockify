...
# Add a text input for the user to enter the stock ticker
...
# If a stock ticker is entered, fetch data
if stock_ticker:
    ...
    # Show the entered stock ticker as disabled input for display purposes
